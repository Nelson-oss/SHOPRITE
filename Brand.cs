...
namespace SHOPRITE
{
    public partial class Brand : Form
    {
        ...
        //Data retrieving from tbBrand to dgbBrand on Brand form
        ...
        {
            //For updating and deleting brand by cell click from tbBrand
            ...
            if (colName=="Delete")
            {
                if (MessageBox.Show("Are you sure you want to delete this record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Brand has been deleted successfully.", "SHOPRITE", MessageBoxButtons.OK, MessageBoxIcon.Information);
