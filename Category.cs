...
namespace SHOPRITE
{
...

    {
        ...
        //Data retrieving from tbCategory to dgvCategory on Category form
        ...
        private void dgvCategory_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (colName == "Delete")
            {
                if (MessageBox.Show("Are you sure you want to delete this record", "Delete Record", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    cm.ExecuteNonQuery();
                    cn.Close();
                    MessageBox.Show("Category has been deleted successfully.", "SHOPRITE", MessageBoxButtons.OK, MessageBoxIcon.Information);
